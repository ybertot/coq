...
language will be described in Chapter :ref:`TODO-9-The-tactic-language`.
...
:ref:`TODO-8.1.1-Set-Default-Goal-Selector`) is used.
...
instantiate (see :ref:`TODO-2.11-Existential-Variables`). The instantiation is
