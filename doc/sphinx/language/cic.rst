...
:Converted by: Clément Pit-Claudel, Richard L Ford, 
...
has type :math:`\Set` leads to an inconsistent theory [Coq86]_, the language of
...
#. if :math:`x` is a variable and :math:`T`, :math:`u` are terms then
   ...
   λ-abstraction of λ-calculus [Bar81]_. The term :math:`λ x:T . u` is a function
...
refer the interested reader to [Coq85]_.
...
and is more precisely studied in [Moh93]_, [Wer94]_.
...
Coquand in [Coq92]_. One is the definition by pattern-matching. The
...
notion can be found in [Gim94]_. The first stage is to precise on which
...
definitions can be found in [Gimenez95b]_, [Gim98]_, [GimCas05]_.
